...
export const Artworks: Artwork[] = [
  {
    ...
    props: {
      ...
      localImagePaths: [
        `${import.meta.env.BASE_URL}/artworks/flyman/flyman-collage.png`,
      ],
  ...
  },
  {
    ...
    props: {
      artists: ["Kim Grewal (She/Her)", "Elisha Wang (She/Her)"],
      aboutArtists: [
  ...
  },
  {
    ...
    props: {
      ...
      aboutArtists: [
        ...
        "Originally from Alberta, I am the 2017 recipient of the Alberta Foundation for the Arts’ Queens Golden Jubilee Scholarship. I have a BFA from Emily Carr University of Art + Design (2020). I have been working as a curatorial assistant for the past three years and developing my practice on the side. As an emerging artist myself, I am grateful for the opportunity to have co-founded the Emerging Creators Incubator at the Art Gallery at Evergreen where I work.",
      ],
      artistLinks: ["@anna.luth", "anna.luth27@gmail.com"],
      medium:
        "(Medium: oil and acrylic on canvas, MDF panel and shelf, ceramic, jeans | 29”*35”*10.5”)",
      aboutArtwork: [
        "I moved away from all of my family 5 years ago. This was particularly difficult during the pandemic when distance felt magnified and time distorted, and my mother’s mother became really ill. My grandma and I were really close, so it was difficult to know she was living out her final months in a hospice and I couldn’t say goodbye. It was a slow going, and there were many times we thought her time was nearly up, but she’d pull through and recover, only to decline again. This magnified a sensation of unravelling, at times feeling tightly wound, and other moments like I have to let go. This piece became a meditation on grief as I processed my emotions and the complications of linage and family histories.",
      ...
      localImagePaths: [
        `${import.meta.env.BASE_URL}/artworks/hers-and-mine/hers-and-mine.png`,
      ],
      localAudioPaths: null,
  ...
  },
  {
    ...
    props: {
      artists: ["Zyrell Castillo (She/Her)"],
      aboutArtists: [
      ...
      medium: "(Medium: Inks, Gouache, Watercolors | 9*12 in)",
      aboutArtwork: [
  ...
  },
  {
    ...
    props: {
      ...
      medium: "(Medium: woodblock print | 8.5*6 in)",
      aboutArtwork: [
  ...
  },
  {
    ...
    props: {
      artists: ["DANI YOUR DARLING (They/Them)"],
      aboutArtists: [
  ...
  },
  {
    ...
    props: {
      artists: ["Juno (She/Her)"],
      aboutArtists: [
        "My name is Jasmine Choi, I'm a 2nd year UBC student who has already dropped out once and is indecisively going into Sociology, Anthropology, and/or Visual Arts. My parents are from Hong Kong but they raised their family (i.e. me) in Vancouver. I'm the youngest of three siblings by 7 and 8 years respectively. I work in the food industry for a living currently, I've worked as a cook/bartender/server at a few restaurants and a food truck. I'm queer and asian. I have greater aspirations to keep pursuing art and writing in my life, more specifically I have an affinity towards poetry and it usually infiltrates all other art that I do.",
        "I've lived in Metro Vancouver all my life and I grew up in Coquitlam. I also grew up in Church where my mom and dad were the leaders of the ministry. Later on, my mom went on to become the children's pastor of a church our entire family was deeply embedded in. In a way, I did grow up in Coquitlam, but more honestly, I grew up in the church community more than I did Coquitlam. In these past few years, my family has since separated from the church.",
        "I currently live in Vancouver with my girlfriend while attending UBC and working.",
      ],
      artistLinks: ["jasmineyukar@outlook.com"],
      medium: "(Medium: book/journal)",
      aboutArtwork: [
        "My mom and I are parallel. My other family members comment on it quite a bit how similar we are in terms of personality and temperament. It's been a blessing and a curse at times, depending on when during my life you would ask me. We're both very quiet but strong individuals, she passed down to me our shared maternal traits of stubbornness, devotion, sensitivity, and an intense love. Because of our similarities, we understand each other on a very abstract, ethereal way - but at the very same time our resemblance spawns a lot of tension, stubbornness, and volatile emotions. Our parallels also extend from our personalities to our bodily circumstances. Our relationship was taken to another level when she had breast cancer. Later on, I found a lump in my own breast. (We both turned out okay!) We slowly started to realize all the other things we had in common: depression, mania, complications with periods, fertility issues, etc. At that point, it wasn't just our minds and temperaments that were parallel but also our bodies. I was able to tap into a kind of empathy that only my mother and I shared.",
        "I was interested not only in our relationship, but the ones that have informed the environment of ours - i.e., my grandma (her mom), and my great-grandma (her grandmother). At the time I made this work, I was living with both my mom and my grandma (her mom), and so there were many thoughts running through my head about our maternal lineage, how my mom's relationality with her mom has informed mine, and how my mom and I's relationship will inform my possible future daughters. I wanted to explore in particular, the parallels between childhood and motherhood, and I did so by exploring my own memories and talking with my mom. The work is meant to capture some of my own perspectives on motherhood, but more notably how my experiences meshes with and is informed by my mother's childhood and life. I also want to mention the somewhat quiet vitality of my grandmother in this work. She has dementia and a turbulent, spirited relationship with my mother, and so it was their relationship that brought about more questions of intergenerational trauma and memory. In this work, I question my own ideas of memories (or the loss of it), genetic inheritance, legacy, and motherhood. I could go on with more details but that's the gist of it, so far at least.",
      ],
      localImagePaths: [
        `${
          import.meta.env.BASE_URL
  ...
  },
  {
    ...
    props: {
      ...
      localImagePaths: [
        `${import.meta.env.BASE_URL}/artworks/still-life/01.png`,
        `${import.meta.env.BASE_URL}/artworks/still-life/02.png`,
      ],
      localAudioPaths: null,
      youtubeEmbedURLs: null,
    },
  ...
  },
  {
    ...
    props: {
      artists: ["Nazanin Oghanian (She/Her)"],
      aboutArtists: [
      ...
      medium: "(Medium: Six-channel video installation)",
      aboutArtwork: [
      ...
      localImagePaths: [
        `${import.meta.env.BASE_URL}/artworks/thread-of-red/thread-of-red.png`,
      ],
      localAudioPaths: null,
